...
customCamera.transitionSpeed = 0.02
...
do
    ...
    local function renderPlayer(args,p)
        ...
        customCamera.drawQuadToScene(args,playerBuffer,originalPriority,p.x + p.width*0.5,p.y + p.height*0.5,playerBuffer.width,playerBuffer.height,0,0)
    end
    ...
    local function renderBlock(args,b)
        ...
        if Block.SIZEABLE_MAP[b.id] then
            ...
            if b.width > sizableBuffer.width or b.height > sizableBuffer.height then
                ...
                sizableBuffer:clear(customCamera.convertPriority(args,priority))
            end
            ...
            sizable.drawSizable(b,camera,customCamera.convertPriority(args,priority),sizableBuffer)
