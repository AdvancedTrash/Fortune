...
local backgroundLauncher = require("AI/backgroundLauncher")
...
local sampleNPCSettings = {
	...
	frames = 10,
	framestyle = 0,
	framespeed = 3, -- number of ticks (in-game frames) between animation frame changes
	...
	--backgroundLauncher specific configs
	actAsLauncherPlatform = true,	-- if true, the background launcher will act like a solid platform that triggers when you jump while holding up on top of it
	idleframes = 3,-- how many frames on the spritesheet are reserved for the platform not being used. The remaining ones will be used for the launch animation
	idleframespeed = 12,-- framespeed of the idle animation. For launch animation framespeed, use proper framespeed config
	launchSFX = 24,	-- sound effect that plays when launching the player into the background. By default 24 (spring)
...
function sampleNPC.onInitAPI()
	...
	backgroundLauncher.register(npcID)
end
