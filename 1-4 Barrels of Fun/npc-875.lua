...
function sampleNPC.onTickNPC(v)
	...
	for _, z in ipairs(NPC.get(874)) do
		if Colliders.collide(z, v) == false then
			z2 = NPC.spawn(874, v.x, v.y)
		elseif Colliders.collide(z, v) and player.holdingNPC == z then
			z2 = NPC.spawn(874, v.x, v.y)
		end
	end
	
	z2.layerObj = v.layerObj
