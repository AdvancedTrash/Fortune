...
local sampleNPCSettings = {
	...
	idleframes = 4,-- how many frames on the spritesheet are reserved for the platform not being used. The remaining ones will be used for the launch animation
	idleframespeed = 8,-- framespeed of the idle animation. For launch animation framespeed, use proper framespeed config
